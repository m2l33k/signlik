...
public class FriendshipController {
    ...
    @GetMapping("/sent")
    public ResponseEntity<List<FriendshipEntity>> getSentRequests(Authentication authentication) {
        String userEmail = authentication.getName();
        return ResponseEntity.ok(friendshipService.getSentFriendRequests(userEmail));
    }
}
